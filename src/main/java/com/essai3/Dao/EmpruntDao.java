...
public class EmpruntDao {
    public static ObservableList<Emprunt> showEmprunts() throws SQLException, ClassNotFoundException {
        ...
        ResultSet rs = st.executeQuery("select utilisateur.nom,utilisateur.prenom,livre.titre,isbn,date_emprunt,date_retour,status from emprunt join utilisateur on utilisateur.id=utilisateur_id join edition on edition.id=edition_id join livre on livre.id=edition.livre_id");
        while (rs.next()) {
