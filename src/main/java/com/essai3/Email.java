...
public class Email {
    ...
    public Email(final String var1, final String var2) {
        ...
        try {
            ...
            Logger.getLogger(com.essai3.Email.class.getName()).log(Level.SEVERE, (String)null, var5);
        }
    ...
    public Email(String var1, int var2, final String var3, final String var4) {
        ...
        try {
            ...
            Logger.getLogger(com.essai3.Email.class.getName()).log(Level.SEVERE, (String)null, var7);
        }
